...
<jsp:useBean id="autoDictJa" scope="request" type="com.example.KaskoWebClient.model.api.requests.CalcRequest.AutoDictJa"/>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><form:select path="autoDictJa">
                            <form:option value="NONE" label=" --- Select --- "/>
                            <c:forEach var="elem" items="${autoDictJa.models}">
                                ${elem.name}
                            </c:forEach>
                        </form:select></td>
                    </tr>
